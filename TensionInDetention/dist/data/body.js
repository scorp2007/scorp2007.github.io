...
(function (TProject) {
    var GameplayTablesUI = (function (_super) {
        ...
        function GameplayTablesUI(game, x, y, manager) {
            ...
            _this.pausePanel.x = _this.game.width / 2;
            _this.pausePanel.y = _this.game.height / 2;
            ...
            _this.endPanel.x = _this.game.width / 2;
            _this.endPanel.y = _this.game.height / 2;
            ...
            _this.failPanel.x = _this.game.width / 2;
            _this.failPanel.y = _this.game.height / 2;
        ...
        GameplayTablesUI.prototype.showPausePanel = function () {
            ...
            var tween = this.game.add.tween(this.pausePanel).to({ x: this.game.width / 2, y: this.game.height / 2 }, 100, Phaser.Easing.Linear.None, true, 0, 0, false);
        ...
        GameplayTablesUI.prototype.showWinPanel = function (stars) {
            ...
            this.endPanel.y = -150;
            this.blackScreen.alpha = 0;
            var tween = this.game.add.tween(this.endPanel).to({ x: this.game.width / 2, y: this.game.height / 2 }, 200, Phaser.Easing.Linear.None, true, 0, 0, false);
        ...
        GameplayTablesUI.prototype.showFailPanel = function () {
            ...
            this.blackScreen.alpha = 0;
            var tween = this.game.add.tween(this.failPanel).to({ x: this.game.width / 2, y: this.game.height / 2 }, 200, Phaser.Easing.Linear.None, true, 0, 0, false);
            var tween = this.game.add.tween(this.blackScreen).to({ alpha: 0.5 }, 300, Phaser.Easing.Linear.None, true, 0, 0, false);
        };
...
(function (TProject) {
    var GameplayUI = (function (_super) {
        ...
        function GameplayUI(game, x, y, manager) {
            ...
            _this.levelPanel.x = _this.game.width / 2 - 54;
            ...
            _this.restartBtn.x = _this.game.width / 2 - 18;
            ...
            _this.pauseBtn.x = _this.game.width / 2 + 18;
            ...
            _this.soundBtn.x = _this.game.width / 2 + 54;
        ...
        GameplayUI.prototype.createMobiles = function () {
            ...
            this.mobAct.x = this.game.width - 34 - 10;
            this.mobAct.y = 512;
            this.mobAct.alpha = 0.5;
...
(function (TProject) {
    var MainMenu = (function (_super) {
        ...
        function MainMenu(game, x, y, manager) {
            ...
            _this.logo.x = _this.game.width / 2;
            _this.logo.y = _this.game.height / 2;
